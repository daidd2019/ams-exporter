...
import (
	...
	"github.com/daidd2019/ams-exporter/collector"
...
var (
	...
	metricsNamespace = flag.String("metric.namespace", "ams", "Prometheus metrics namespace, as the prefix of metrics name")
)
